      ...
      <div class="grid-4 footer_redes">
        ...
        <ul>
          <li><a href="http://facebook.com" target="_blank"><img
                src="<?= get_stylesheet_directory_uri() ?>/img/redes-sociais/facebook.png" alt="Facebook Bikcraft"></a>
          </li>
          <li><a href="http://instagram.com" target="_blank"><img
                src="<?= get_stylesheet_directory_uri() ?>/img/redes-sociais/instagram.png"
                alt="Instagram Bikcraft"></a></li>
          <li><a href="http://twitter.com" target="_blank"><img
                src="<?= get_stylesheet_directory_uri() ?>/img/redes-sociais/twitter.png" alt="Twitter Bikcraft"></a>
          </li>
        </ul>
      </div>
...
<!-- Inicio do Footer Wordpress -->
<?php wp_footer(); ?>
<!-- Final do Footer Wordpress -->
